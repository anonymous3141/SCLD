...
def evolve_overdamped_cmcd(
    ...
    def evolve(aux, i, stable=grad_clipping):
        ...
        fk_mean = (
            z
            - eps * uf
            - eps * apply_fun_approx_network(params["approx_network"], z, i)
        )
...
def evolve_overdamped_cmcd_reverse(
    ...
    def evolve(aux, i, stable=grad_clipping):
        ...
        bk_mean = (
            z
            - eps * ub
            + eps * apply_fun_approx_network(params["approx_network"], z, i + 1)
        )
        ...
        fk_mean = (
            z_new
            - eps * uf
            - eps * apply_fun_approx_network(params["approx_network"], z_new, i)
        )
