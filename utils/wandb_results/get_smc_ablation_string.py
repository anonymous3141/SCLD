...
def elbo_eubo(alg, dim, hmc, mh, resampling):
    config = {
        "local": {
            "entity": "denblessing",
            ...
            "config": {
                ...
                "_fields.hmc": {"values": [hmc]},
                "_fields.mh": {"values": [mh]},
                "_fields.use_resampling": {"values": [resampling]},
            },
            "output_path": "",
            # 'history_samples': 80
        }
    ...
    for i in batch:
        for d in dim:
            for b in tf:
                ...
                elbo_eubo(alg=alg, dim=d, hmc=True, mh=True, resampling=b)
